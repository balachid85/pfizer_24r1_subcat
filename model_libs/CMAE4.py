...
# Embedded file name: CMAE4.py
# Compiled at: 2021-01-21 10:29:07
# Size of source mod 2**32: 7607 bytes
...
class CMAE4(BaseSDQApi):
    ...
    def execute(self):
        ...
        domain_list = [
         'AE', 'CM']
        sub_cat = 'CMAE4'
        subjects = self.get_subjects(study, domain_list=domain_list, per_page=10000) #['10322011']#
...
if __name__ == '__main__':
    ...
    rule_id = sys.argv[4]
    version = sys.argv[5]
    rule = CMAE4(study_id, account_id, job_id, rule_id, version)
    rule.run()