...
class CMAE7(BaseSDQApi):
    ...
    def execute(self):
        ...
        domain_list = [
         'AE', 'CM']
        sub_cat = 'CMAE7'
        subjects = self.get_subjects(study, domain_list=domain_list, per_page=10000) #[10031003]#[10061003]#
                            ...
                            if len(ae_cm_records[0]) > 0:
                                for cm_formindex, ae_records in ae_cm_records[0].items():
                                    for ae_record in ae_records:
                                        ...
                                        print(subject,"***********")
                                        if cmaer.upper() == 'YES':
                                            # print(cm_stdt,cm_endt)
                                            cm_stdt = str(cm_stdt).upper()
                                            cm_endt = str(cm_endt).upper()
                                            if ('UNK' in cm_stdt) or ('UNK' in cm_endt):
                                                ...
                                                if valid_drug:
                                                    ...
                                                    # formidx = cm_record['FORMIDX'].values[0]
                                                    # if 'UNK' in cm_stdt or len(cm_stdt) < 5:
                                                    #     date = cm_stdt
                                                    # else:
                                                    #     if 'UNK' in cm_endt or len(cm_endt) < 5:
                                                    #         date = cm_endt
...
if __name__ == '__main__':
    ...
    rule_id = sys.argv[2]
    version = sys.argv[3]
    rule = CMAE7(study_id, rule_id, version)
    rule.run()