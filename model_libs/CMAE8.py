...
# Embedded file name: CMAE8.py
# Compiled at: 2021-02-23 19:34:22
                            ...
                            if len(ae_cm_records[0]) > 0:
                                for cm_formindex, ae_records in ae_cm_records[0].items():
                                    for ae_record in ae_records:
                                        ...
                                        if cmaer.upper() == 'YES' and cmongo.upper() == 'YES' and type(ae_endt) != float and ae_endt != 'null':
                                            subcate_report_dict = {}
                                            report_dict = {}
...
if __name__ == '__main__':
    ...
    rule_id = sys.argv[2]
    version = sys.argv[3]
    rule = CMAE8(study_id, rule_id, version)
    rule.run()