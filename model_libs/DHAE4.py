...
class DHAE4(BaseSDQApi):
    domain_list = ['AE','DD']

    def execute(self):
        study = self.study_id
        domain_list = self.domain_list
        sub_cat = self.__class__.__name__ #'DHAE4'
        ...
        for subject in tqdm.tqdm(subjects):
            ...
            try:
                ...
                try:
                    ...
                    ae_df = ae_df[ae_df[dt_cols[1]].notna()]
...
if __name__ == '__main__':
    ...
    # python DHAE4.py 1 1 52 1 0.1 > dhae4log.txt
    study_id = sys.argv[1]
    account_id = sys.argv[2]    
    rule_id = sys.argv[3]
    job_id = sys.argv[4]
    version = sys.argv[5]
    rule = DHAE4(study_id, account_id, job_id, rule_id, version)
