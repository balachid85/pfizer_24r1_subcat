...
Changes: 
16-08-22 -  [EDIT #1] - extracting only the date Form the impute date
12-10-22 -  [EDIT #2] - Code change to handle raw date fields                   
'''
...
class CMAE1_1(BaseSDQApi):
    ...
    def execute(self):
        ...
        domain_list = ['AE', 'CM']
        sub_cat = 'CMAE1_1'
        subjects = self.get_subjects(study, domain_list = domain_list, per_page = 10000) #[10371004]#
...
if __name__ == '__main__':
    ...
    rule_id = sys.argv[4]
    version = sys.argv[5]
    rule = CMAE1_1(study_id, account_id, job_id, rule_id, version)
    rule.run()
