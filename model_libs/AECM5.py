...
# Embedded file name: AECM5.py
# Compiled at: 2021-01-21 13:08:44
# Size of source mod 2**32: 8627 bytes
                                    ...
                                    for cm_record in cm_records:
                                        ...
                                        if drug_flag:
                                            ...
                                            if valid_drug:
                                                ...
                                                cm_stdt1 = cm_record['CMSTDAT'].values[0]
                                                cm_endt1 = cm_record['CMENDAT'].values[0]
                                                cm_ongo1 = cm_record['CMONGO'].values[0]
                                                if cm_endt1 == 'null':
                                                    cm_endt1 = 'blank'
...
if __name__ == '__main__':
    ...
    rule_id = sys.argv[2]
    version = sys.argv[3]
    rule = AECM5(study_id, rule_id, version)
    rule.run()