...
class AEOV2_1(BaseSDQApi):
    ...
    def execute(self):
        ...
        subjects = self.get_subjects(study, domain_list=(self.domain_list), per_page=10000)# [88880012,88880013,88880014]#
                                ...
                                for ind in new_ae_record.index.tolist():
                                    ...
                                    if aeterm_flag:
                                        ...
                                        query_text_param = {'AESPID':aespid, 
                                         ...
                                         'AEONGO1':aeongo1, 
                                         'AESEV':aesev}
                                        is_ov_duplicate = check_if_duplicate(subjid=(int(ae_record1['subjid'])), subcat='AEOV2_1', index=(int(ae_record1['form_index'])), report=subcate_report_dict)
...
if __name__ == '__main__':
    ...
    rule_id = sys.argv[4]
    version = sys.argv[5]
    rule = AEOV2_1(study_id, account_id, job_id, rule_id, version)
    rule.run()